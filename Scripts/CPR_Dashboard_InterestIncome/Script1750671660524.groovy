...
WebUI.setText(findTestObject('Object Repository/Page_Halaman Login/input_Masuk ke Akun Anda_user'), 'Admin')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Halaman Login/input_Masuk ke Akun Anda_password'), 'lsAMOYxk6kE=')
...
WebUI.click(findTestObject('Object Repository/Page_BAMS CPR/span_Interest Income'))
